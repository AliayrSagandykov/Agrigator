...
const ru = {
  ...
  home: {
    ...
    examsSub: "От школьного ЕНТ до международных IELTS и SAT. Выбирай цель и сравнивай тюторов по проверенным результатам.",
    tutorsWord: "тюторов",
  ...
  tutorDash: {
    ...
    trialRequestsTitle: "Записи на пробный (Calendly)", trialBookedBadge: "записался", trialOpenedBadge: "только заходил", trialEmpty: "Пока никто не открывал бронь.",
  ...
  profile: {
    ...
    trialBooked: "Пробный урок забронирован!", trialBookedNote: "Тьютор получил уведомление. Детали урока придут на email из Calendly.",
...
const kk: Dict = {
  ...
  home: {
    ...
    examsSub: "Мектептегі ЕНТ-дан халықаралық IELTS пен SAT-қа дейін. Мақсатты таңдап, тьюторларды тексерілген нәтижелер бойынша салыстыр.",
    tutorsWord: "тьютор",
  ...
  tutorDash: {
    ...
    trialRequestsTitle: "Сынаққа жазылғандар (Calendly)", trialBookedBadge: "жазылды", trialOpenedBadge: "тек кірді", trialEmpty: "Әзірге ешкім брондауды ашқан жоқ.",
  ...
  profile: {
    ...
    trialBooked: "Сынақ сабақ брондалды!", trialBookedNote: "Тьюторға хабарлама жіберілді. Сабақ мәліметтері Calendly-дегі email-ге келеді.",
...
const en: Dict = {
  ...
  home: {
    ...
    examsSub: "From school ЕНТ to international IELTS and SAT. Pick your goal and compare tutors by verified results.",
    tutorsWord: "tutors",
  ...
  tutorDash: {
    ...
    trialRequestsTitle: "Trial sign-ups (Calendly)", trialBookedBadge: "booked", trialOpenedBadge: "only opened", trialEmpty: "No one has opened booking yet.",
  ...
  profile: {
    ...
    trialBooked: "Trial lesson booked!", trialBookedNote: "The tutor has been notified. Lesson details will arrive at your Calendly email.",
