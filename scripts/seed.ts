...
const TUTORS = [
  ...
  { id: "t9", name: "Ерлан Мухтаров", email: "erlan@agrigator.kz", exams: ["GMAT", "GRE"], subjects: ["GMAT / GRE Quant + Verbal"], price: 18000, format: "online", city: "Онлайн", experience: 9, rating: 4.9, sponsored: false, aiVerified: true, photo: "https://i.pravatar.cc/240?img=68", gradient: "g3", responseTime: "~4 часа", avatarColor: "#f59e0b", ownScores: [{ exam: "GMAT", score: "760", verified: true }], methodology: "INSEAD MBA; экс-консультант Big3", languages: ["Русский", "Английский"], bio: "GMAT 760, MBA INSEAD. Готовлю взрослых профессионалов к GMAT/GRE и помогаю со стратегией поступления.", achievements: ["Студенты поступали в INSEAD, LBS, Wharton", "Средний рост GMAT: +140"], stat: { metric: "GMAT Score", before: 560, after: 700, sample: 38, passRate: 84 }, lessons: 210, retention: 72, trial: false, trialFree: false, videoUrl: "", contacts: { instagram: "erlan.gmat", telegram: "erlan_gmat", whatsapp: "77011110009", phone: "+7 701 111 00 09", email: "erlan@agrigator.kz" } },
...
const COURSES = [
  ...
  { id: "c14", title: "GRE Quant 165+", provider: "MBA Lab", exams: ["GRE"], price: 130000, priceUnit: "курс", format: "online", city: "Онлайн", duration: "8 недель", groupSize: "до 8 человек", level: "Advanced", rating: 4.6, students: 110, sponsored: false, aiVerified: false, emoji: "🧠", gradient: "g2", description: "Quant-секция GRE для магистратуры и PhD.", features: ["ETS official guides", "Адаптивные домашки"], schedule: "Пн/Чт 19:00–21:00", scoreStats: { metric: "GRE Quant", before: 152, after: 166, sampleSize: 42, passRate: 83 }, trial: false, trialFree: false, videoUrl: "", contacts: { instagram: "mba.lab", telegram: "mbalab", whatsapp: "77071234510", phone: "+7 707 123 45 10", email: "apply@mbalab.kz" }, moneyBack: false },
